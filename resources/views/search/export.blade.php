	...
	<div id="cv" class="instaFade">
		<div class="mainDetails">
			...
			<div id="name">
				...
				<br>
				<h2 class="quickFade delayThree">Nama Anda</h2>
			</div>
			
			<div id="contactDetails" class="quickFade delayFour">
			<table style="text-align: left">
				<tr>
					<td>E-mail</td><td>:</td><td><a href="mailto:Contoh@gmail.com" target="_blank">Contoh@gmail.com</a></td>
				</tr>
				<tr>
					<td>Facebook</td><td>:</td><td> <a href="http://www.facebook.com/afif.sungkawa"> www.facebook.com/afif.sungkawa</a></td>
				</tr>
				<tr>
					<td>Mobile</td><td>:</td><td> 089000000000</td>
				</tr>
			</table>
			</div>
			<div class="clear"></div>
